...
class test.xmlOutputSpec(TraitedSpec):
...
class test.xml(CommandLine):

    input_spec = test.xmlInputSpec
    output_spec = test.xmlOutputSpec
    _cmd = "Slicer3 --launch test.xml "
    ...
    def _format_arg(self, name, spec, value):
        ...
        return super(test.xml, self)._format_arg(name, spec, value)
