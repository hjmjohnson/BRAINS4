...
void vtkRectangle::Execute()
{
  ...
  // v44 - nudge in corner of map Gradient showed some sort of wrap-around on
  // the outer edge
  ...
  // The TextureTurn count is the # of 90 degree clockwise turns to make for the
  // texture coords
...
// like vtkTextuireText::SetPositionOffset - don't move in regular space -
// offset the points
