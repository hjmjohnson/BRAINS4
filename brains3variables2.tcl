...
set ::CSWIG_TAG "ITK-3-4"
set ::SLICER_TAG "http://www.na-mic.org/svn/Slicer3/trunk"
set ::CMAKE_TAG "CMake-2-4-7"
#set ::TEEM_TAG "HEAD"
set ::TEEM_TAG "Teem-1-9-0-patches"
set ::KWWidgets_TAG "Slicer-3-0-bp"
set ::VTK_TAG "ParaView-3-2-1"
set ::ITK_TAG ITK-3-4
...
if { 0 } {
#  These MUST be defined before this point or everything fails.
...
switch $::tcl_platform(os) {
    ...
    "Darwin" {
        ...
        set ::PYTHON_TEST_FILE $::SLICER_BUILD/bin/python
        set ::PYTHON_INCLUDE_PATH /usr/include/python2.3
        set ::PYTHON_LIB_FILE /usr/lib/libpython2.3.$shared_lib_ext
        set ::NUMPY_TEST_FILE $::SLICER_LIB/python-build/lib/python2.5/site-packages/numpy/lib/_compiled_base.$shared_lib_ext
        set ::TEEM_TEST_FILE $::SLICER_LIB/teem-build/bin/unu
        set ::VTK_TEST_FILE $::SLICER_LIB/VTK-build/bin/vtk
        set ::KWWidgets_TEST_FILE $::SLICER_LIB/KWWidgets-build/bin/libKWWidgets.$shared_lib_ext
        ...
        set ::VTK_TCL_DLIB $::TCL_LIB_DIR/libtcl8.4.$shared_lib_ext
        set ::VTK_TCL_STUB $::TCL_LIB_DIR/libtclstub8.4.a
        set ::VTK_TK_LIB $::TCL_LIB_DIR/libtk8.4.$shared_lib_ext
        set ::VTK_TK_DLIB $::TCL_LIB_DIR/libtk8.4.$shared_lib_ext
        set ::VTK_TK_STUB $::TCL_LIB_DIR/libtkstub8.4.a
        set ::VTK_TCLSH $::TCL_BIN_DIR/tclsh8.4
        set ::VTK_WISH $::TCL_BIN_DIR/wish8.4
        set ::VTK_TCL_INC $::SLICER_LIB/tcl-build/include
        set ::VTK_TK_INC $::SLICER_LIB/tcl-build/include
        ...
        set ::Slicer3_TEST_FILE $::SLICER_LIB/Slicer3-build/bin/Slicer3
        set ::GENERATECLP_EXE $::SLICER_LIB/Slicer3-build/bin/GenerateCLP
    }
    "Linux" {
        set ::TEEM_BIN_DIR  $::TEEM_BUILD_DIR/bin
        ...
        set ::BLT_TEST_FILE $::TCL_BIN_DIR/bltwish24
        set ::PYTHON_TEST_FILE $::SLICER_BUILD/bin/python
        set ::PYTHON_INCLUDE_PATH $::SLICER_BUILD/include/python2.5
        set ::PYTHON_LIB_FILE $::SLICER_BUILD/lib/libpython2.5.$shared_lib_ext
    ...
    # Windows NT currently covers WinNT, Win2000, XP Home, XP Pro
        ...
        # This next series of lines are a hack until Windows can make install
        set ::TCL_LIB_DIR $::SLICER_LIB/tcl/tcl-build/lib
        set ::TCL_BIN_DIR $::SLICER_LIB/tcl/tcl-build/bin
        set ::CMAKE_PATH  $::SLICER_LIB/cmake-2.4.7-win32-x86
        ...
        set ::PYTHON_TEST_FILE $::SLICER_BUILD/bin/python
        set ::PYTHON_INCLUDE_PATH $::SLICER_BUILD/include/python2.5
        set ::PYTHON_LIB_FILE $::SLICER_BUILD/lib/python2.5.$shared_lib_ext
        set ::NUMPY_TEST_FILE $::SLICER_LIB/python-build/lib/python2.5/site-packages/numpy/lib/_compiled_base.dll
        set ::TEEM_TEST_FILE $::SLICER_LIB/teem-build/bin/$::VTK_BUILD_TYPE/unu.exe
        set ::VTK_TEST_FILE $::SLICER_LIB/VTK-build/bin/$::VTK_BUILD_TYPE/vtk.exe
        set ::KWWidgets_TEST_FILE $::SLICER_LIB/KWWidgets-build/bin/$::env(VTK_BUILD_SUBDIR)/KWWidgets.lib
        ...
        set ::VTK_TCL_INC $::SLICER_LIB/tcl/tcl-build/include
        set ::VTK_TK_LIB $::TCL_LIB_DIR/tk84.lib
        set ::VTK_TK_INC $::SLICER_LIB/tcl/tcl-build/include
        set ::VTK_TCLSH $::TCL_BIN_DIR/tclsh84.exe
        set ::ITK_TEST_FILE $::SLICER_LIB/Insight-build/bin/$::VTK_BUILD_TYPE/ITKCommon.dll
        ...
        set ::SLICERLIBCURL_TEST_FILE $::SLICER_LIB/cmcurl-build/bin/$::VTK_BUILD_TYPE/slicerlibcurl.lib
        set ::Slicer3_TEST_FILE $::SLICER_LIB/Slicer3-build/bin/$::VTK_BUILD_TYPE/Slicer3-real.exe
        set ::GENERATECLP_EXE $::SLICER_LIB/Slicer3-build/bin/$::VTK_BUILD_TYPE/GenerateCLP
    }
    default {
...
switch $::tcl_platform(os) {
    ...
    default {
        ...
        if { [file exists "c:/Program Files/Microsoft Visual Studio 8/Common7/IDE/devenv.exe"] } {
            ...
            set ::NMAKE "c:/Program\ Files/Microsoft\ Visual\ Studio\ 8/VC/bin/nmake.exe"
        }
