...
Program:   vtkINRIA3D
Module:    $Id: vtkFibersManager.cxx 1073 2009-01-19 16:14:21Z filus $
Language:  C++
Author:    $Author: filus $
Date:      $Date: 2009-01-19 10:14:21 -0600 (Mon, 19 Jan 2009) $
...
vtkCxxRevisionMacro(vtkFibersManager, "$Revision: 1073 $");
...
vtkFibersManager::vtkFibersManager()
{
  ...
  if ( vtkFibersManager::GetUseHardwareShaders() )
    {
    vtkFibersMapper *mapper = vtkFibersMapper::New();
...
void vtkFibersManager::RemoveAllActors()
{
  if ( m_RWin )
    ...
    // m_RWin->GetRenderWindow()->GetRenderers()->GetNextItem();
...
void vtkFibersManager::SetInput(vtkPolyData *input)
{
  ...
  // std::cout << "Max number of lines: " << this->MaximumNumberOfFibers << ".
  // Actual number of lines: " << totalLines << ". Ratio: " << ratio
  // <<std::endl;
