...
class BRAINSFitInputSpec(CommandLineInputSpec):
    ...
    minimumStepLength = traits.List("traits.Float", sep = ",",argstr = "--minimumStepLength %s")
    ...
    interpolationMode = traits.Enum("NearestNeighbor","Linear","BSpline","WindowedSinc","RigidInPlace", argstr = "--interpolationMode %s")
...
class BRAINSFit(CommandLine):
    ...
    _cmd = "/scratch/brains/BRAINS3-build/src/bin/BRAINSFit "
