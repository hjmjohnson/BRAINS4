...
BuildExtPackage(BuildScripts
  https://www.nitrc.org/svn/brains/BuildScripts/trunk "{20110527}" "" )
...
BuildExtPackage(BRAINSCommonLib
  http://www.nitrc.org/svn/brains/BRAINSCommonLib/trunk "{20110527}" "BuildScripts;SlicerExecutionModel")
...
BuildExtPackage(BRAINSFit
  https://www.nitrc.org/svn/multimodereg/trunk  "{20110527}" "BRAINSCommonLib" )
BuildExtPackage(BRAINSMush
  https://www.nitrc.org/svn/brainsmush/trunk  "{20110527}" "BRAINSCommonLib" )
BuildExtPackage(BRAINSDemonWarp
  https://www.nitrc.org/svn/brainsdemonwarp/trunk  "{20110527}" "BRAINSCommonLib" )
BuildExtPackage(BRAINSROIAuto
  https://www.nitrc.org/svn/brainsroiauto/trunk  "{20110527}" "BRAINSCommonLib" )
BuildExtPackage(BRAINSCut
  https://www.nitrc.org/svn/brainscut/trunk  "{20110527}" "BRAINSCommonLib" )
BuildExtPackage(GTRACT
  https://www.nitrc.org/svn/vmagnotta/GTRACT  "{20110527}" "BRAINSCommonLib" )

BuildExtPackage(BRAINSMultiModeSegment
  https://www.nitrc.org/svn/brains/BRAINS/trunk/BRAINSTools/BRAINSMultiModeSegment  "{20110527}" "BRAINSCommonLib" )
BuildExtPackage(BRAINSResample
  https://www.nitrc.org/svn/brains/BRAINS/trunk/BRAINSTools/BRAINSResample  "{20110527}" "BRAINSCommonLib" )
BuildExtPackage(BRAINSInitilizedControlPoints
  https://www.nitrc.org/svn/brains/BRAINS/trunk/BRAINSTools/BRAINSInitilizedControlPoints  "{20110527}" "BRAINSCommonLib" )

if("${ITK_VERSION_MAJOR}" EQUAL "3")
  BuildExtPackage(DicomToNrrdConverter
    http://svn.slicer.org/Slicer3/trunk/Applications/CLI/DicomToNrrdConverter  "{20110527}" "BRAINSCommonLib" )
  #
  # DicomSignature won't work with ITK4
  BuildExtPackage(DicomSignature
    https://www.nitrc.org/svn/brains/BRAINS/trunk/BRAINSTools/DicomSignature  "{20110527}" "BRAINSCommonLib" )
endif("${ITK_VERSION_MAJOR}" EQUAL "3")

## HACK if(${${CMAKE_PROJECT_NAME}_USE_QT})
## HACK   BuildExtPackage(BRAINSImageEval
## HACK     http://www.nitrc.org/svn/brainsimageeval  "{20110527}" "BRAINSCommonLib" )
...
BuildExtPackage(BRAINSABC
  https://www.nitrc.org/svn/brains/BRAINS/trunk/BRAINSTools/BRAINSABC  "{20110527}" "BRAINSCommonLib;${ReferenceAtlas_DEPEND}" )

#-----------------------------------------------------------------------------
# BRAINSConstellationDetector
#-----------------------------------------------------------------------------
BuildExtPackage(BRAINSConstellationDetector
  https://www.nitrc.org/svn/brainscdetector/trunk  "{20110527}" "BRAINSCommonLib" )
