...
elseif(APPLE)
  set(${CMAKE_PROJECT_NAME}_PYTHON_EXECUTABLE ${CMAKE_BINARY_DIR}/Library/Framework/Python.framework/Versions/2.6/bin/python)
  set(${CMAKE_PROJECT_NAME}_PYTHON_LIBRARY ${CMAKE_BINARY_DIR}/Library/Framework/Python.framework/Versions/2.6/Python)
  set(${CMAKE_PROJECT_NAME}_PYTHON_FRAMEWORK ${CMAKE_BINARY_DIR}/Library/Framework/Python.framework)
  set(${CMAKE_PROJECT_NAME}_PYTHON_INCLUDE ${CMAKE_BINARY_DIR}/Library/Framework/Python.framework/Headers)
else()
